...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--dataset_mode', type=str, default='custom_rgbd_lidar', help='chooses how datasets are loaded. [unaligned | aligned | single | colorization | custom_rgbd_lidar]')
